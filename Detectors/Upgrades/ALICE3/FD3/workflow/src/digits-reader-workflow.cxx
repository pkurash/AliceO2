...
/// \brief Implementation of FD3 digits reader
///
...
WorkflowSpec defineDataProcessing(const ConfigContext& ctx)
{
  ...
  DataProcessorSpec producer = o2::fd3::getDigitReaderSpec(!ctx.options().get<bool>("disable-mc"), ctx.options().get<bool>("disable-trigger-input"));
