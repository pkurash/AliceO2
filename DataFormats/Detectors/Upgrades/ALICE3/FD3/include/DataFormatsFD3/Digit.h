...
/// \author podist.kurashvili@cern.ch

#ifndef _FD3_DIGIT_H_
#define _FD3_DIGIT_H_
...
struct Digit {
  ...
  static constexpr char sDigitBranchName[] = "FD3DIGITSBC";
  o2::dataformats::RangeReference<int, int> ref{};
  Triggers mTriggers{};               // pattern of triggers  in this BC
  uint8_t mEventStatus = 0;           //Status of event from FD3, such as Pileup , etc
...
struct TriggersExt {
  ...
  static constexpr char sDigitBranchName[] = "FD3DIGITSTRGEXT";
