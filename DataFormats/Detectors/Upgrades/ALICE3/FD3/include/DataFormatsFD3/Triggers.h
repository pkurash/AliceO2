...
// \file Triggers.h
/// \brief Class to describe triggers common for FD detector
/// \author podist Kurashvili

#ifndef _FD3_TRIGGERS_H_
#define _FD3_TRIGGERS_H_
...
class Triggers
{
 public:
  ...
  // FIT triggers, to be updated!!! P.K.
